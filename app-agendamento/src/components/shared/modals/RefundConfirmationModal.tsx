    ...
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center p-4">
      <div className="bg-white p-6 rounded-lg shadow-xl max-w-sm w-full">
        ...
        <p className="mt-2 text-sm text-gray-600">
          Ao confirmar, a solicitação de cancelamento será enviada. O reembolso
          será processado automaticamente conforme a Política de Cancelamento.
        </p>

        {/* TEXTO DO CHECKBOX SIMPLIFICADO */}
        <div className="mt-4">
          <label className="flex items-center gap-3 p-3 bg-gray-50 rounded-md cursor-pointer">
            ...
            <span className="text-sm text-gray-700 font-semibold">
              Declaro que li e estou ciente da Política de Cancelamento.
            </span>
          </label>
        </div>
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          >
            {isLoading ? "A enviar..." : "Confirmar e Cancelar"}
          </button>
        </div>
      </div>
    </div>
